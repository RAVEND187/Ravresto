...
<body>
    ...
    <header>
        <div class="container">
            <h1><a href="index.php">Ravresto</a></h1>
            <ul>
    ...
    <div class="section">
        ...
        <div class="box">
            ...
            <div class="col-2">
                ...
                <p><a href="https://api.whatsapp.com/send?phone=(+62)<?php echo $a->admin_telp ?>&text=Hai, saya tertarik dengan makanan anda." target="_blank" ">Hubungi via Whatsapp</a></p>
            </div>
            </div>
        </div>
    </div>
